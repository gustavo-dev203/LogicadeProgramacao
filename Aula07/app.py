'''
    ...
    modos de ação:
        ...
        - "w" : escrita(sobrescreve o conteudo antigo) do arquivo | write
        - "a" : adiciona conteúdo ao arquivo(no final) | append
        - "x" : criar um arquivo | Exclusive
        - "b" : arquivos binarios | binary
        - "t" : arquivos de texto | .txt
'''
